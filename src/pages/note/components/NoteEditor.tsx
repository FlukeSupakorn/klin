...
export function NoteEditor() {
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex flex-col" data-color-mode="light">
      {/* Header */}
            ...
            {isRenaming ? (
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="px-4 py-2 border border-indigo-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 text-2xl font-bold"
                  autoFocus
                />
                <button
                  onClick={handleRename}
                  className="h-10 w-10 rounded-lg bg-indigo-600 text-white flex items-center justify-center hover:bg-indigo-700"
                >
              ...
              <div className="flex items-center gap-3 group">
                ...
                <button
                  ...
                  className="h-8 w-8 rounded-lg hover:bg-slate-100 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                  title="Rename note"
                >
