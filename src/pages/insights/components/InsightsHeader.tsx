  ...
  return (
    <div className="bg-theme-background border-b border-theme px-6 py-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-theme-text">AI Insights</h1>
          <p className="text-sm text-theme-secondary">Intelligent file organization and summaries</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-semibold text-theme-text mb-2">No Destination Folders</h2>
